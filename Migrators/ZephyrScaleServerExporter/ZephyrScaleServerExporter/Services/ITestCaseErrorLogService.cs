...
/// </summary>
public interface ITestCaseErrorLogService
{
    /// <summary>
    ...
    void LogError(Exception ex, string contextMessage, ZephyrTestCase? problematicTestCase = null, IEnumerable<ZephyrTestCase>? associatedTestCases = null);
} 