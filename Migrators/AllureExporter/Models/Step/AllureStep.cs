...
namespace AllureExporter.Models.Step;

public class AllureStep
{
    [JsonPropertyName("name")] public string Name { get; set; } = string.Empty;

    [JsonPropertyName("attachments")] public List<AllureAttachment>? Attachments { get; set; }

    [JsonPropertyName("steps")] public List<AllureStep> Steps { get; set; } = new();

    [JsonPropertyName("keyword")] public string Keyword { get; set; } = string.Empty;

    [JsonPropertyName("expectedResult")] public string ExpectedResult { get; set; } = string.Empty;
}
...
public class AllureScenarioStep
{
    ...
    [JsonPropertyName("children")] public List<long>? NestedStepIds { get; set; }

    [JsonPropertyName("expectedResult")] public string? ExpectedResult { get; set; }

    [JsonPropertyName("sharedStepId")] public long? SharedStepId { get; set; }
}
