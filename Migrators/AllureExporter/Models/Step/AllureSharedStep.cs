...
{
    [JsonPropertyName("content")] public List<AllureSharedStep> Content { get; set; } = new();
...
{
    [JsonPropertyName("body")] public string Name { get; set; } = string.Empty;

    [JsonPropertyName("children")] public List<long> NestedStepIds { get; set; } = new();
}
...
{
    [JsonPropertyName("root")] public AllureScenarioRoot? Root { get; set; }
