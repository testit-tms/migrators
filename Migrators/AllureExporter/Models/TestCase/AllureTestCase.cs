...
{
    [JsonPropertyName("content")] public List<AllureTestCaseBase> Content { get; set; } = new();
...
public class AllureTestCase : AllureTestCaseBase
{
    ...
    [JsonPropertyName("descriptionHtml")] public string DescriptionHtml { get; set; } = string.Empty;

    [JsonPropertyName("tags")] public List<Tag> Tags { get; set; } = new();

    [JsonPropertyName("links")] public List<TestCaseLink> Links { get; set; } = new();

    [JsonPropertyName("status")] public Status? Status { get; set; }

    [JsonPropertyName("testLayer")] public TestLayer? Layer { get; set; }

    [JsonPropertyName("workflow")] public Workflow? Workflow { get; set; }

    [JsonPropertyName("precondition")] public string? Precondition { get; set; }

    [JsonPropertyName("preconditionHtml")] public string? PreconditionHtml { get; set; }

    [JsonPropertyName("expectedResult")] public string? ExpectedResult { get; set; }

    [JsonPropertyName("expectedResultHtml")]
